...
public class MainView extends AppLayout implements AfterNavigationObserver {
	...
	@Inject
	public MainView(AccessAnnotationChecker accessChecker, SecurityUtils securityUtils) {
		...
		menu = createMenuTabs(accessChecker);
	...
	private Tabs createMenuTabs(AccessAnnotationChecker accessChecker) {
		final Tabs tabs = new Tabs();
		tabs.setOrientation(Tabs.Orientation.HORIZONTAL);
		tabs.add(getAvailableTabs(accessChecker));
		return tabs;
	}

	private Tab[] getAvailableTabs(AccessAnnotationChecker accessChecker) {
